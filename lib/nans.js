...
/**
* FUNCTION: createNaNs( dims )
*	Returns a function to create a NaN-filled multidimensional array.
*
* @param {Number[]} dims - dimensions
* @returns {Function} function to create a NaN-filled multidimensional array
*/
function createNaNs( dims ) {
	...
	*/
	...
	// Create the code which assigns the value NaN...
	i = ndims - 1;
	fcn += 'o' + i;
	if ( len < 64000 ) {
		fcn += '[i' + i + ']=NaN;';
	...
	*/
} // end FUNCTION createNaNs()


// EXPORTS //

module.exports = createNaNs;
